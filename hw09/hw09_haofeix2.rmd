...
bptest(model)
```
For the swiss model, p value = 0.3, which is super large. So that we cannot reject the null hypothesis and tend to believe that the constant variance assumption has not been violated.
